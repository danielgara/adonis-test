...
Route.get('/cart/purchase', 'CartController.purchase').as('cart.purchase').middleware('auth');
Route.get('/account/orders', 'AccountController.orders').as('account.orders').middleware('auth');
